...
try:
    while True:
        ...
        # Bot indicates that the coding shows the light as on
        engine.say("The grow light should be on. If it is not on run the light on script.")
        engine.runAndWait()
